...
import {listWorkflowTemplates, type ListWorkflowTemplates200Response} from "../services/api"
import {useNotification} from "../providers/notification/NotificationContext"
import {handleEither} from "../utils/either"
import type {WorkflowTemplateSummary, Pagination} from "@approvio/api"
...
const WorkflowTemplatesPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTemplates = async () => {
      ...
      const result = await listWorkflowTemplates(page + 1, rowsPerPage, authToken)
