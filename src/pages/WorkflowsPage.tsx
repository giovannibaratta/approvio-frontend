...
import {listWorkflows, type ListWorkflows200Response} from "../services/api"
import {useNotification} from "../providers/notification/NotificationContext"
import {handleEither} from "../utils/either"
import type {Workflow, Pagination} from "@approvio/api"
...
const WorkflowsPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchWorkflows = async () => {
      ...
      const result = await listWorkflows(page + 1, rowsPerPage, authToken)
  ...
  const actions = (workflow: Workflow) => (
    <Button
      variant="outlined"
      size="small"
      component={RouterLink}
      to={`/workflows/${workflow.id}/votes`}
    >
      View Votes
    </Button>
  )
